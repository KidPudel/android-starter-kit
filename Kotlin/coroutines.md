...
- `join` will **block code** in the thread it was called, until coroutine is finished (**_all join coroutines will go together_**) - otherwise code will just go further and finish, or print null for some variables
