...
They **can be launched on other threads (Dispateched.IO, Default, etc.)** or they **could be launched on the same main thread**, _that would block the UI for example, but it would certanly finish their job._
